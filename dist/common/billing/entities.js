...
class BotBillingOptions {
    ...
    updateOption(option, value) {
        ...
        switch (option) {
            ...
            case "nlp":
                this.nlp =
                    this.nlp + value >= 0 ? this.nlp + value : 0;
                break;
            case "api_storages":
                this.api_storages =
                    this.api_storages + value >= 0
                        ? this.api_storages + value
                        : 0;
                break;
            case "sso_connection":
...
class BillingPlan extends BotBillingOptions {
    constructor(plan) {
        ...
        this.name = plan.name || constants_1.PlanNameConvention[this.id];
...
class BotBilling {
    ...
    registerPlanDefaults(planId) {
        ...
        this.plans[planId].name =
            this.plans[planId].name || constants_1.PlanNameConvention[planId];
